...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("Running train booking Sustumm");
        ...
        try{
            ...
            System.out.println("There is something wrong"+ ex.getMessage()); // <-- This shows the real error
            return;
        }
            ...
            switch (option){
                case 1:
                    ...
                    try {
                        ...
                        System.out.println("Cannot Sign Up User! Error: " + ex.getMessage());
                    }
                    break;
